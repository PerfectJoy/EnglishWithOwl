...
import mn.alge.lessons.ListenWrite;
import mn.alge.lessons.MatchWord;
import mn.alge.lessons.Vocabulary;
import mn.alge.lessons.WriteWord;
...
public class BeginnerLesson extends ActionBarActivity implements
	 ...
	 * R.drawable.btn_bg_1_vocabulary, R.drawable.btn_bg_2_findingpictures,
	 * R.drawable.btn_bg_3_choosewords, R.drawable.btn_bg_4_listenchoose,
	 * R.drawable.btn_bg_5_matchwords, R.drawable.btn_bg_6_listenwrite,
	 * R.drawable.btn_bg_7_writewords};
	 */
	...
	public static class CategoryBeginner extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			v = inflater.inflate(R.layout.beginner_category_item_image,
					container, false);
			categoryImage = (ImageView) v.findViewById(R.id.img_category);
			switch (mNum) {
			case 0:
				categoryImage
						.setImageResource(R.drawable.btn_bg_2_findingpictures);
				break;
			case 1:
				categoryImage
						.setImageResource(R.drawable.btn_bg_2_findingpictures);
			...
			case 3:
				categoryImage
						.setImageResource(R.drawable.btn_bg_4_listenchoose);
				break;
				...
				public void onClick(View v) {
					...
					case 0:
						i = new Intent(getApplicationContext(),
								Vocabulary.class);
						/*
						 * fr.beginTransaction().replace(R.id.beg_less_layout,
						 * Vocabulary.newInstance(position), "Voc")
						 * .addToBackStack(null).commit();
						 */
						// Toast.makeText(getApplicationContext(),
						// Integer.toString(mNum), 0).show();
						// i.putExtra("sedew", mNum);
						break;
					case 1:
						i = new Intent(getApplicationContext(),
								FindPicture.class);
					...
					case 3:
						...
						break;
					case 4:
						i = new Intent(getApplicationContext(), MatchWord.class);
						break;
					case 5:
						i = new Intent(getApplicationContext(),
								ListenWrite.class);
						break;
					case 6:
						i = new Intent(getApplicationContext(), WriteWord.class);
						break;
